...
<body>
	...
	<div class="agileits_header">
		<div class="w3l_offers">
			<a href="products.html">SALE MOBILE !</a>
		</div>
				...
				<li class="dropdown profile_details_drop"><a href="#"
					...
					<div class="mega-dropdown-menu">
						...
						<button type="button" class="btn btn-primary"
									data-toggle="modal" data-target="#modalLRForm">
									Login</button>
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1>
					<a href="index.html"><span>Scale</span> Mobile</a>
				</h1>
			</div>
	...
	<div class="banner">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<c:forEach var="menu" items="${menus }">
							<li><a href="${menu.getHref() }">${menu.getName() }</a></li>
						</c:forEach>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
		...
		<div class="w3l_banner_nav_right">
			...
			<!-- flexSlider -->
			<link rel="stylesheet" href="/resouces/css/flexslider.css"
